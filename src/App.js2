...
// --- Stripe Payment Component (Manual) ---
// This component now manually loads and manages the Stripe.js script to avoid build errors.
const StripeCheckout = ({ activeRaffle, setPaymentModalOpen }) => {
    ...
    // Effect to load the Stripe.js script dynamically
    useEffect(() => {
        if (window.Stripe) {
            // IMPORTANT: Replace with your actual Stripe publishable key
            setStripe(window.Stripe('pk_test_51Hh2YBEgC0X0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0'));
        } else {
            ...
            script.onload = () => {
                // IMPORTANT: Replace with your actual Stripe publishable key
                setStripe(window.Stripe('pk_test_51Hh2YBEgC0X0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0g0'));
            };
    ...
    // Effect to create and mount the Stripe Card Element
    useEffect(() => {
        if (stripe && cardContainerRef.current) {
            ...
            // Cleanup function to destroy the card element
            return () => {
                card.destroy();
            };
        }
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div ref={cardContainerRef} className="p-4 bg-gray-700 rounded-lg"></div>
...
function App() {
    ...
    const [view, setView] = useState('login'); // 'login', 'signup', 'raffles', 'profile', 'create', 'detail'
    ...
    const createRaffle = async () => {
        ...
        try {
            ...
            // 2. Create raffle document in Firestore
            ...
            {paymentModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
                    <div className="bg-gray-800 p-8 rounded-xl shadow-2xl w-full max-w-md relative">
                        ...
                        <StripeCheckout activeRaffle={activeRaffleForPayment} setPaymentModalOpen={setPaymentModalOpen} />
                    </div>
                </div>
            )}
        </div>
