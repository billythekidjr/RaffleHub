...
// SOLUTION: To fix the 'no-undef' ESLint error, we must check if these
// environment-specific variables exist before using them. The 'typeof' check 
// safely determines if a variable is defined without causing a ReferenceError.
const firebaseConfig = typeof __firebase_config !== 'undefined' ? JSON.parse(__firebase_config) : {};
const appId = typeof __app_id !== 'undefined' ? __app_id : 'default-app-id';

// --- Initialize Firebase ---
// We also add a check here to ensure the app doesn't try to initialize if the
// config from the environment was missing.
