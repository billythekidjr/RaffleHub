    ...
    useEffect(() => {
        ...
        scriptStripe.onload = () => {
            ...
            scriptReactStripe.onload = () => {
                const { loadStripe, Elements: Elem, CardElement: Card, useStripe: uStripe, useElements: uElem } = window.ReactStripe;
                Elements = Elem;
                CardElement = Card;
                useStripe = uStripe;
                useElements = uElem;
    ...
    const CheckoutForm = () => {
        ...
        const handleSubmit = async (event) => {
            ...
            if (raffle && user) {
                ...
                const raffleDocRef = doc(raffleCollectionRef.current, raffle.id);
                try {
