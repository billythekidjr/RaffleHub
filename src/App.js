...
// SOLUTION: To definitively fix the 'no-undef' ESLint error, we must access these
// globally injected variables via the `window` object. This is the standard way to
// safely access globals in a browser environment and will satisfy the linter.
let firebaseConfig = {};
