...
try {
    if (window && typeof window.__firebase_config !== 'undefined') {
        firebaseConfig = JSON.parse(window.__firebase_config);
    }
    if (window && typeof window.__app_id !== 'undefined') {
...
const StripeProvider = ({ activeRaffle, setPaymentModalOpen }) => {
...
function App() {
    ...
    return (
        <div className="bg-gray-900 text-white min-h-screen font-sans">
            ...
            {paymentModalOpen && stripeInstance && stripeReady && (
